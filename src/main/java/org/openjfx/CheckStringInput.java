...
public class CheckStringInput {
    ...
    private final static String NAME_PATTERN = "[A-ZÆØÅ][a-zæøå]+[ -]([A-ZÆØÅ][a-zæøå]+)?[ ]?([A-ZÆØÅ][a-zæøå]+)?[ ]?([A-ZÆØÅ][a-zæøå]+)?";
    ...
    private final static String PHONENR_PATTERN = "[^-]([(]?[+]?[0-9]{1,3}[)]?)?( )?([- ])?[0-9]+([- ][0-9]*)?([- ][0-9]*)?([- ][0-9]*)?([- ][0-9]*)?";
